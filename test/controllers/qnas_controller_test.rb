...
class QnasControllerTest < ActionController::TestCase
  ...
  test "should create qna" do
    assert_difference('Qna.count') do
      post :create, qna: { content: @qna.content, email: @qna.email, review_count: @qna.review_count, title: @qna.title }
    end
  ...
  test "should update qna" do
    patch :update, id: @qna, qna: { content: @qna.content, email: @qna.email, review_count: @qna.review_count, title: @qna.title }
    assert_redirected_to qna_path(assigns(:qna))
  end
