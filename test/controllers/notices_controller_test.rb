...
class NoticesControllerTest < ActionController::TestCase
  ...
  test "should create notice" do
    assert_difference('Notice.count') do
      post :create, notice: { content: @notice.content, email: @notice.email, review_count: @notice.review_count, title: @notice.title }
    end
  ...
  test "should update notice" do
    patch :update, id: @notice, notice: { content: @notice.content, email: @notice.email, review_count: @notice.review_count, title: @notice.title }
    assert_redirected_to notice_path(assigns(:notice))
  end
