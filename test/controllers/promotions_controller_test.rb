...
class PromotionsControllerTest < ActionController::TestCase
  ...
  test "should create promotion" do
    assert_difference('Promotion.count') do
      post :create, promotion: { content: @promotion.content, email: @promotion.email, review_count: @promotion.review_count, title: @promotion.title }
    end
  ...
  test "should update promotion" do
    patch :update, id: @promotion, promotion: { content: @promotion.content, email: @promotion.email, review_count: @promotion.review_count, title: @promotion.title }
    assert_redirected_to promotion_path(assigns(:promotion))
  end
